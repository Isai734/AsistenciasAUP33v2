 ...
 */
public class AlumnoEditAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private static final String TAG = AlumnoEditAdapter.class.getSimpleName();
    ...
    public AlumnoEditAdapter(Cursor items, OnListAlumnoListener listener) {
    ...
    public void setValues() {
        while (mCursor.moveToNext()) {
            long _id = mCursor.getLong(mCursor.getColumnIndex(ContratoAsistencia.ColumnasRegistroAsistencia._ID));
            String detalle=mCursor.getString(mCursor.getColumnIndex(ContratoAsistencia.ColumnasRegistroAsistencia.DETALLE));
            if (!mapAsistentes.containsKey(_id))
                mapAsistentes.put(_id, detalle);
    ...
    private Alumno cursorToAlumno(Cursor cursor) {
        return new Alumno(
                cursor.getString(cursor.getColumnIndex(ContratoAsistencia.ColumnasRegistroAsistencia.ID_ALUMNO)),
